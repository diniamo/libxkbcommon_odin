...
foreign lib {
	...
	* @memberof xkb_compose_table
	*/
	compose_table_new_from_file :: proc(_context: ^Context, file: ^File, locale: cstring, format: Compose_Format, flags: Compose_Compile_Flags) -> ^Compose_Table ---
	...
	* @memberof xkb_compose_table
	*/
	compose_table_new_from_buffer :: proc(_context: ^Context, buffer: cstring, length: c.size_t, locale: cstring, format: Compose_Format, flags: Compose_Compile_Flags) -> ^Compose_Table ---
...
foreign lib {
	...
	* @since 1.6.0
	*/
	compose_table_entry_sequence :: proc(entry: ^Compose_Table_Entry, sequence_length: ^c.size_t) -> ^Keysym ---
...
foreign lib {
	...
	* @memberof xkb_compose_state
	**/
	compose_state_get_utf8 :: proc(state: ^Compose_State, buffer: cstring, size: c.size_t) -> i32 ---
