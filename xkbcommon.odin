...
LAYOUT_INVALID  :: (0xffffffff)

/** Invalid level index */
LEVEL_INVALID   :: (0xffffffff)

/** Invalid modifier index */
MOD_INVALID     :: (0xffffffff)

/** Invalid LED index */
LED_INVALID     :: (0xffffffff)

/** Maximum legal keycode */
KEYCODE_MAX     :: (0xffffffff-1)
...
foreign lib {
	...
	* [RMLVO]: @ref RMLVO-intro
	*/
	rmlvo_builder_new :: proc(_context: ^Context, rules: cstring, model: cstring, flags: Rmlvo_Builder_Flags) -> ^Rmlvo_Builder ---
	...
	* [RMLVO]: @ref RMLVO-intro
	*/
	rmlvo_builder_append_layout :: proc(rmlvo: ^Rmlvo_Builder, layout: cstring, variant: cstring, options: ^cstring, options_len: c.size_t) -> bool ---
...
foreign lib {
	...
	* [KcCGST]: @ref KcCGST-intro
	*/
	components_names_from_rules :: proc(_context: ^Context, rmlvo_in: ^Rule_Names, rmlvo_out: ^Rule_Names, components_out: ^Component_Names) -> bool ---
...
foreign lib {
	...
	*/
	keysym_to_utf8 :: proc(keysym: Keysym, buffer: cstring, size: c.size_t) -> i32 ---
...
foreign lib {
	...
	* [RMLVO]: @ref RMLVO-intro
	*/
	keymap_new_from_names2 :: proc(_context: ^Context, names: ^Rule_Names, format: Keymap_Format, flags: Keymap_Compile_Flags) -> ^Keymap ---
	...
	* @memberof xkb_keymap
	*/
	keymap_new_from_file :: proc(_context: ^Context, file: ^File, format: Keymap_Format, flags: Keymap_Compile_Flags) -> ^Keymap ---
	...
	* @since 0.3.0
	*/
	keymap_new_from_buffer :: proc(_context: ^Context, buffer: cstring, length: c.size_t, format: Keymap_Format, flags: Keymap_Compile_Flags) -> ^Keymap ---
...
foreign lib {
	...
	* [xkb_v1]: https://wayland.freedesktop.org/docs/html/apa.html#protocol-spec-wl_keyboard-enum-keymap_format
	*/
	keymap_get_as_string2 :: proc(keymap: ^Keymap, format: Keymap_Format, flags: Keymap_Serialize_Flags) -> cstring ---
...
* @since 0.3.1
*/
Keymap_Key_Iter :: proc "c" (keymap: ^Keymap, key: Keycode, data: rawptr)
...
foreign lib {
	...
	*/
	keymap_mod_get_mask :: proc(keymap: ^Keymap, name: cstring) -> Mod_Mask ---
	...
	* [real modifiers]: @ref real-modifier-def
	*/
	keymap_mod_get_mask2 :: proc(keymap: ^Keymap, idx: Mod_Index) -> Mod_Mask ---
	...
	* @since 1.0.0
	*/
	keymap_key_get_mods_for_level :: proc(keymap: ^Keymap, key: Keycode, layout: Layout_Index, level: Level_Index, masks_out: ^Mod_Mask, masks_size: c.size_t) -> c.size_t ---
...
foreign lib {
	...
	* @sa xkb_state_update_mask()
	*/
	state_update_latched_locked :: proc(state: ^State, affect_latched_mods: Mod_Mask, latched_mods: Mod_Mask, affect_latched_layout: bool, latched_layout: i32, affect_locked_mods: Mod_Mask, locked_mods: Mod_Mask, affect_locked_layout: bool, locked_layout: i32) -> State_Component ---
	...
	* @since 0.4.1
	*/
	state_key_get_utf8 :: proc(state: ^State, key: Keycode, buffer: cstring, size: c.size_t) -> i32 ---
